#!/usr/bin/env python3
"""
Simple Direct Command Client for Xeryon Demo Station
...
async def main():
    ...
    logger.info(f"Starting simple direct command client for {STATION_ID}")
        ...
        try:
            ...
            while not shutdown_requested:
                try:
                    ...
                    # Check if the connection is still open using state
                    try:
